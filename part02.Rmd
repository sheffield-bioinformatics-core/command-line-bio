...
<div class="exercise">
## Exercise
We will also need the Human reference genome sequence (DNA FASTA) for chromosome 22. Download the repeat-masked (`rm`) version of this sequence to the `ref_data` folder using the command-line.
</div>
